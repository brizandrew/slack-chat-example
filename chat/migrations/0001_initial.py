# -*- coding: utf-8 -*-
# Generated by Django 1.11.10 on 2018-02-16 22:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_datetime', models.DateTimeField(verbose_name=b'Create date/time (Pacific)')),
                ('last_modified_datetime', models.DateTimeField(null=True, verbose_name=b'Last modified date/time (Pacific)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('html', models.CharField(help_text=b'HTML code representaion of the message.', max_length=3000)),
